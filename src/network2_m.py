...
Matrix implementation version of network2.py for improved performance
...
class L1(object):
    ...
    @staticmethod
    def get(w, eta, lmbda, n):
        """Return the update term of the L1 regularization for SGD"""
...
class L2(object):
    ...
    @staticmethod
    def get(w, eta, lmbda, n):
        """Return the update term of the L2 regularization for SGD"""
...
class Network(object):
    ...
    def set_matrix_biases(self, mini_batch_size):
        """Sets the matrix biases for the matrix based implementation"""
    ...
    def update_mini_batch(self, mini_batch, eta, lmbda, n):
        ...
        self.weights = [self.reg.get(w, eta, lmbda, n)-(eta/len(mini_batch))*nw
